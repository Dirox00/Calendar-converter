...
file = "Data/Horario_Ing_Mat_1o_BIEN.pdf"
...
diff = 0
n = 4
tabula.convert_into(file, "Data/converted.csv", output_format="csv", pages=n) # better one by one


with open("Data/converted.csv", 'r') as f:
